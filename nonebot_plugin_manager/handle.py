...
class Handle:
    ...
    def ls(cls, args: Namespace) -> str:
        ...
        if args.store:
            ...
            if not args.conv["group"] and args.is_superuser or args.conv["group"]:
                args.conv["user"] = []
    ...
    def block(cls, args: Namespace) -> str:
        ...
        result |= plugin_manager.block_plugin(args.plugin, args.conv)
    ...
    def unblock(cls, args: Namespace) -> str:
        ...
        result |= plugin_manager.unblock_plugin(args.plugin, args.conv)
